 ...
 * @author Admin
 */
public class FilterCreateAccount implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        String accname = request.getParameter("accnamecreate").trim();
        String pass = request.getParameter("passcreate").trim();
        String error;
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("FilterCreateAccount:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("FilterCreateAccount:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("FilterCreateAccount:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("FilterCreateAccount()");
        }
        StringBuffer sb = new StringBuffer("FilterCreateAccount(");
