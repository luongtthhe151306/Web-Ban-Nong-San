 ...
 * @author Admin
 */
@WebFilter(filterName = "FilterOrder", servletNames = {"OrderProductServlet"})
public class FilterOrder implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("FilterOrder:DoBeforeProcessing");
        }
...
//        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("FilterOrder:DoAfterProcessing");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("FilterOrder:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("FilterOrder(");
