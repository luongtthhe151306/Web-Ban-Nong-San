        ...
        <header class="header">
            <div class="grid">
                ...
                <div class="header-home-search">
                    ...
                    <div class="cart">
                        <%ArrayList<Order> orderlist = md.getOrder(IdA);
                ...
                <div class="col-sm-9">
                    <form class="order">
                        <ul class="row order-list">                       
                            ...
                            <li class="order-item">
                                <div class="row">
                                    <div class="col-sm-4"><img src="<c:out value="${order.getProduct().getImg()}"></c:out>" class="img-order"></div>
                                    <div class="col-sm-8 order-content">
                                        ...
                                        <a href="" style="text-decoration: none ;">Xóa sản phẩm</a>
                                    </div>
                                </div>
                            </li>
                            </c:forEach>                         
                            <li class="bill">
                                <span>Mã đơn hàng: </span></br>
                                <span>Tổng tiền: 250.000vnd</span></br>
                                <span>Địa chỉ giao hàng: vĩnh khúc</span></br>
                                <span>Số điện thoại người nhận: 0123456789</span></br>
