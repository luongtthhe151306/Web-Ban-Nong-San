            ...
            <div class="grid">
                <nav class="header-navbar">
                    ...
                    <ul class="header-list">
                        ...
                        <li class="header-item">
                            <a href="AccountPage.jsp?IdA=<%= acc.getIdA()%>&IdC=<%= acc.getIdA()%>" class="header-item-link"><%= acc.getAccountName()%></a>
                        </li>
                        <li class="header-item">
                    ...
                    <nav class="category">
                        ...
                        <ul class="category-list">
                            ...
                            <li class="category-item">
                                <a href="ProductTypeServlet?idT=<%=type.getIdType()%>&IdA=<%= acc.getIdA()%>&page=1" class="catagory-item-link"><%= type.getTypeName()%></a>
                            </li>
                            <%}%>
                        </ul>
                    </nav>
